...
const examSessionCtrl = require('../controller/examSessionController');
...
//============================= Exam Sessions =====================================================
// Bắt đầu làm bài (POST form từ trang danh sách kỳ thi)
router.post('/exam-sessions/start', protect('student'), examSessionCtrl.startExamSession);

// Lưu đáp án (AJAX)
router.post('/exam-sessions/answer', protect('student'), examSessionCtrl.submitAnswer);

// Nộp bài
router.post('/exam-sessions/submit', protect('student'), examSessionCtrl.submitExam);

// Trang làm bài
router.get('/exam-sessions/:sessionId/do', protect('student'), examSessionCtrl.doExamPage);

// Trang kết quả
router.get('/exam-sessions/:sessionId/result', protect('student'), examSessionCtrl.getResult);

// Lịch sử làm bài
router.get('/exam-sessions/history', protect('student'), examSessionCtrl.getHistory);
